function renderHomeMarkup(array) {  
   ...
   const homeMarkup = array.map(({ poster_path, title, genre_ids, release_date }) => {
    ...
    return `<li class="film__item"><a class="film__link" href=""><div class=“film__card”>
    <div class=“film__thumb”>
  <img class="film__image" src="https://image.tmdb.org/t/p/w500${poster_path}" alt="${title}" loading="lazy" /></div>
